...
from .views import register_view, CustomLoginView, CustomLogoutView, ProfileView, ProviderListView, \
    ...
    GoodDetailView, CreateSupplyView, SupplyListView, CreateSaleView, SalesListView, GetGoodPriceView
from .api_views import ProviderAPIView, GoodAPIView, ProviderDetailAPI, GoodDetailAPI, SaleDetailAPI
...
urlpatterns = [
    ...
    path('create_supply/', CreateSupplyView.as_view(), name='create_supply'),
